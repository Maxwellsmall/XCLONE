...
const Header = () => {
  return (
    <div className=" flex bg-black/90 w-full border-b-2 border-b-gray-900 sticky top-0">
      <div className="flex items-center w-[25%] py-4 justify-center hover:bg-gray-900 cursor-pointer">
      ...
      <div className='flex justify-center items-center w-[60px] py-5 hover:bg-gray-900 cursor-pointer'>
