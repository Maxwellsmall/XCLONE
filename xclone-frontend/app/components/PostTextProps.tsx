import { Bookmark, ChartBar, Heart, MessageCircle, Recycle, UploadIcon } from 'lucide-react'
...
const PostTextProps: React.FC<PostsProps> = ({comment, Views, tweet, likes, Profileimage, Name, UserName, time, TextContent, ImageContent, Icons}) => {
  return (
    <>
