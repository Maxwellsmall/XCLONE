  ...
  return (
    <div className='w-full flex flex-col'>
      ...
      <div className='flex justify-between items-center mx-3 my-4'>
        ...
        <h1 className="text-gray-400 cursor-pointer">Who to follow</h1>
        </div>
        <div className='flex justify-center items-center w-[50%] my-3'>

        <h1 className="text-gray-400 cursor-pointer border-b-4 border-blue-500 pb-3">Creators to follow</h1>
        </div>
      </div>
